...
namespace refrigerated_truck
{
    class Program
    {
        ...
        // User IDs.
        static string ScopeID = "0ne000DA656";
        static string DeviceID = "RefrigeratedTruck1";
        static string PrimaryKey = "i6WphcNbKazY3xo669vjU8rObO1cWfupfZ3nNrtkGP8=";
        static string AzureMapsKey = "a7bj6T2BYT1KuirD8_ftaqa2nKlrE5PGbfrwyqLcwJw";
